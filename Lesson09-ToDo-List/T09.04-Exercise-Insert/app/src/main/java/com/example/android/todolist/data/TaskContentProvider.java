    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case TASKS:
                ...
                break;
            // COMPLETED (4) Set the value for the returnedUri and write the default case for unknown 
            // URI's
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
        // COMPLETED (5) Notify the resolver if the uri has been changed, and return the newly 
        // inserted URI
